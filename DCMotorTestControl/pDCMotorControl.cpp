...
//
//----------------------------------------------------------------------
/*!\file    projects/DCMotorTestControl/pDCMotorControl.cpp
 *
 * \author  Aras Dar
 *
 * \date    2018-05-02
 ...
 * \b pDCMotorControl
 *
 * This is the part/process for DC motors control.
 *
 */
//----------------------------------------------------------------------
...
//#include "projects/DCMotorTestControl/gDCMotorControl.h"
...
// Const values
//----------------------------------------------------------------------
const std::string cPROGRAM_DESCRIPTION = "This program executes the DCMotorControl module/group.";
...
void CreateMainGroup(const std::vector<std::string> &remaining_arguments)
{
  ...
  new finroc::DCMotorTestControl::mDCMotorControl(main_thread);
//  new finroc::DCMotorTestControl::gDCMotorControl(main_thread);
