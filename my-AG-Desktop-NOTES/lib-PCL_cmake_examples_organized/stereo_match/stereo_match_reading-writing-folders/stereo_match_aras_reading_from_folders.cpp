...
//		   std::cerr << "left_images: " << left_images[img_index].c_str() << std::endl;
//		   std::cerr << "right_images: " << right_images[img_index].c_str() << std::endl;
//		   cout << "right_images[img_index].c_str(): " << right_images[img_index].c_str() << std::endl;
