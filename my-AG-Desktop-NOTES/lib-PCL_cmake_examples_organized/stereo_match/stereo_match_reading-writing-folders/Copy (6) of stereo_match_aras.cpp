...
//		}
	    ...
	    if(disparity_filename){
			std::string dir_name_ = argv [3];
			std::string file_name_ = argv[4];
			std::stringstream ss;
			ss << dir_name_ << "/" << file_name_ << "_rect_" << img_index << ".png";
			cout << "disparity map for rectified stereo images output: " << ss.str()  << endl;
			imwrite( ss.str(), disp8 );
	    }
