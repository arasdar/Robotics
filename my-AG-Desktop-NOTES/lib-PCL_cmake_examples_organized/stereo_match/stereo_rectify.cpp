...
{
    printf("\nDemo stereo matching converting L and R images into rectified images and creating disparity \n");
    printf("\nUsage: stereo_match <input_left_image_dir> <input_right_image_dir> <output_disparity_image_dir> <output_disparity_image_filename> <output_left_rect_image_dir> <output_left_rect_image_filename> <output_right_rect_image_dir> <output_right_rect_image_filename> [--algorithm=bm|sgbm|hh|var] [--blocksize=<block_size>]\n"
           "[--max-disparity=<max_disparity>] [--scale=scale_factor>] [-i <intrinsic_filename>] [-e <extrinsic_filename>]\n"
           "[--no-display] [-o <saving disparity and rect images?? yes/no>]\n");
}
