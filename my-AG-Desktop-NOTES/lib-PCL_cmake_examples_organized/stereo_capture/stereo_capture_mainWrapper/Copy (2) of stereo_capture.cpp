...
//		Mat frame_found_0;
		...
		imshow("ImageView_right_0", frame_found_0);
...
//		Mat frame_found_1;
		...
		imshow("ImageView_left_1", frame_found_1);
...
//				 return -1;
//			 }// if
//			capture.retrieve(frame_found);
//			/////////save the image with the found chessboard  //aras
//			namedWindow( "ImageView_right_0", 1 );
//			imshow("ImageView_right_0", frame_found);
//
//			//////////left camera camera index=1
//			Mat frame_found_1;
//			if( !capture_1.grab() ){
...
//			Mat img2 = imread(img2_filename, color_mode);
			Mat img1, img2;
			frame_found_0.copyTo(img1);
			frame_found_1.copyTo(img2);
...
//      return (PointCloud<RGB>::Ptr&)cloud; //not
    ...
    run ()
    {
      while (!viewer->wasStopped ())
      {
        ...
        //stereo capture
        // stereo_capture (left_images_folder, right_images_folder);
        stereo_capture ();
