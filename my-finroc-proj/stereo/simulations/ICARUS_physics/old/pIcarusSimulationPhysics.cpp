...
// Namespace usage
//----------------------------------------------------------------------
using namespace finroc::stereo_traversability_experiments::simulation_physics;
...
//  {
  ...
  new gIcarusSimulationPhysics(main_thread);
//    gSimulation *simulation = new gSimulation(main_thread);

  main_thread->SetCycleTime(50);  //100 //more fluently
}
