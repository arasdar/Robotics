...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/pointCloudProcessing/finroc/pSensorProcessing.cpp
 *
 ...
 * \b pSensorProcessing
 *
 * This is the sensor part for testing the point cloud processing in offline.
 *
 */
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//#include "projects/icarus/sensor_processing/pointCloudProcessing/finroc/mSensorProcessing.h"
...
void InitMainGroup(finroc::structure::tThreadContainer *main_thread, const std::vector<std::string> &remaining_arguments)
{
  ...
  new finroc::icarus::sensor_processing::pointCloudProcessing::gSensorProcessing(main_thread);
