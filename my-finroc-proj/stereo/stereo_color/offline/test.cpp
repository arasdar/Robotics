...
main(int argc, char** argv)
{
  ...
  if (argc < 3)
  {
    ...
    PCL_INFO("for example : \n"
             ...
             "aras_stereoTravExp_aras_stereoColor_offline "
             "/mnt/public_work/Testdaten/ICARUS/stereo_lugv_color-haris/2014-09-08_MeF_DS/006-catas/left_rect_006-catas "
             "/mnt/public_work/Testdaten/ICARUS/stereo_lugv_color-haris/2014-09-08_MeF_DS/006-catas/right_rect_006-catas "
