...
main(int argc, char** argv)
{
  ...
  if (argc < 3)
  {
    PCL_INFO("usage: aras_icarus_sensorProcessing_stereoColor_offline_bb left_image_directory right_image_directory intrinsic_parameter_filename extrinsic_parameter_filename\n");
    PCL_INFO("note: images in both left and right folders can be in different format.\n");
    PCL_INFO("for example : \n"
             "aras_icarus_sensorProcessing_stereoColor_offline_bb ~/stereo_images/stereo_lugv/sample/left_rect/ ~/stereo_images/stereo_lugv/sample/right_rect ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/calib_1-ok/intrinsics.yml ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/calib_1-ok/extrinsics.yml\n ");
    return -1;
  }
