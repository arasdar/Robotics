...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/stereo_color/offline/finroc/pSensorProcessing.cpp
 *
 ...
 * \b pSensorProcessing
 *
 * This is the part for testing stereo color in offline mode.
 *
 */
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//#include "projects/icarus/sensor_processing/stereo_color/offline/finroc/mSensorProcessing.h"
...
//  new finroc::icarus::sensor_processing::stereo_color::offline::finroc::mSensorProcessing(main_thread);
//  new finroc::icarus::sensor_processing::stereo_color::offline::finroc::gSensorProcessing(main_thread);
  new finroc::icarus::sensor_processing::stereo_color::offline::gSensorProcessing(main_thread);
