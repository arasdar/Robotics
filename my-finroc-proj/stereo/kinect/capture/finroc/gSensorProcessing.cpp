...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/kinect/capture/finroc/gSensorProcessing.cpp
 *
...
#include "libraries/openni/mOpenNIDevice.h"
...
{
  mKinectCapture* kinect_capture = new mKinectCapture(this);
  ...
  kinect_capture->output_gridmap.ConnectTo(map2canvas->in_map);

  //testing openni device
//  new finroc::openni::mOpenNIDevice(this);
}
