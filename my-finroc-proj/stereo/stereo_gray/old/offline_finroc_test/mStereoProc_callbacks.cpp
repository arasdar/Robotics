...
void mStereoGrayOffline::keyboardCallback(const pcl::visualization::KeyboardEvent& event, void*)
{
  if (event.keyUp())
  {
...
void mStereoGrayOffline::pointPickingcallback(const pcl::visualization::PointPickingEvent& event, void* args)
{
