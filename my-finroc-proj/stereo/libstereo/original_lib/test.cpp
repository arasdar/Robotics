...
#include "projects/icarus/sensor_processing/libstereo/tStereoVisionProcBB.h"
...
main(int argc, char** argv)
{
  ...
  if (argc < 3)
  {
    ...
    PCL_INFO("for example : \n"
             "aras_icarus_sensorProcessing_libstereo_gray ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/left/ ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/right/ ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/calib_1-ok/intrinsics.yml ~/stereo_images/stereo_ravon/stereo_45cm-baseline/2013-10-25_myStereo-baseline-45cm_cart_outside_forest/calib_1-ok/extrinsics.yml\n "
             "aras_icarus_sensorProcessing_libstereo_gray ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/left ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/right/ ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/calib_1_good_used/intrinsics.yml ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/calib_1_good_used/extrinsics.yml\n "
             "aras_icarus_sensorProcessing_libstereo_gray ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/left_ramp ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/right_ramp ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/calib_1_good_used/intrinsics.yml ~/stereo_images/stereo_sugv/2014-02-20_outside-first-dataset/calib_1_good_used/extrinsics.yml\n"
            );
    return -1;
  }
  ...
  /*Process and display*/
//  finroc::icarus::sensor_processing::libstereo::StereoVisionProcACSO stereo_vision_processing(left_images, right_images, img_pairs_num, input_intrinsic_filename, input_extrinsic_filename);
  finroc::icarus::sensor_processing::libstereo::StereoVisionProcBB stereo_vision_processing(left_images, right_images, img_pairs_num, input_intrinsic_filename, input_extrinsic_filename);
