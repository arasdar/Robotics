...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/stereo_sugv/capture_finroc/pSensorProcessing.cpp
 *
 ...
 * \b pSensorProcessing
 *
 * This is a part for sensor processing group.
 *
 */
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//#include "projects/icarus/sensor_processing/stereo_sugv/capture_finroc/mSensorProcessing.h"
...
//  new finroc::icarus::sensor_processing::stereo_sugv::capture_finroc::mSensorProcessing(main_thread);
  new finroc::icarus::sensor_processing::stereo_sugv::capture::gSensorProcessing(main_thread);
