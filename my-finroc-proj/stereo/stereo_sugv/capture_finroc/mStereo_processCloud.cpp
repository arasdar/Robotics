...
void
mStereo::processCloud(const CloudConstPtr& cloud)
{
  /*Compute the normals*/
  ...
  */
  ...
  unsigned thresh = largest; //1; //(cloud->width / 10) * (cloud->height / 10) * 0.05; //(cloud->width / 10) * (cloud->height / 10) * 1.5 * 0.5;  //2500
