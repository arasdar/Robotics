...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/libfeature/tIntegralImageNormalEstimation.hpp
 *
...
////----------------------------------------------------------------------
//// tIntegralImageNormalEstimation constructors
////----------------------------------------------------------------------
//template <>
//tIntegralImageNormalEstimation<>::tIntegralImageNormalEstimation() //:
...
////----------------------------------------------------------------------
//// tIntegralImageNormalEstimation destructor
////----------------------------------------------------------------------
//template <>
//tIntegralImageNormalEstimation<>::~tIntegralImageNormalEstimation()
//{}
//
////----------------------------------------------------------------------
//// tIntegralImageNormalEstimation SomeExampleMethod
////----------------------------------------------------------------------
//template <>
//void tIntegralImageNormalEstimation<>::SomeExampleMethod()
//{
...
tIntegralImageNormalEstimation<PointInT, PointOutT>::~tIntegralImageNormalEstimation()
{
...
tIntegralImageNormalEstimation<PointInT, PointOutT>::initData()
{
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::setRectSize(const int width, const int height)
{
  rect_width_      = width;
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::initSimple3DGradientMethod()
{
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::initCovarianceMatrixMethod()
{
  // number of DataType entries per element (equal or bigger than dimensions)
  int element_stride = sizeof(PointInT) / sizeof(float);
  // number of DataType entries per row (equal or bigger than element_stride number of elements per row)
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::initAverage3DGradientMethod()
{
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::initAverageDepthChangeMethod()
{
  // number of DataType entries per element (equal or bigger than dimensions)
  int element_stride = sizeof(PointInT) / sizeof(float);
  // number of DataType entries per row (equal or bigger than element_stride number of elements per row)
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::computePointNormal(
  const int pos_x, const int pos_y, const unsigned point_index, PointOutT &normal)
{
  ...
  if (normal_estimation_method_ == COVARIANCE_MATRIX)
  {
    ...
    typename tIntegralImage2D<float, 3>::SecondOrderType so_elements;
...
////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::computePointNormalMirror(
  const int pos_x, const int pos_y, const unsigned point_index, PointOutT &normal)
{
  float bad_point = std::numeric_limits<float>::quiet_NaN();
  ...
  if (normal_estimation_method_ == COVARIANCE_MATRIX)
  {
    ...
    unsigned count = 0;
    sumArea<unsigned>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFiniteElementsCountSE, &integral_image_XYZ_, _1, _2, _3, _4), count);
    ...
    Eigen::Vector3f center;
    typename tIntegralImage2D<float, 3>::SecondOrderType so_elements;
    typename tIntegralImage2D<float, 3>::ElementType tmp_center;
    typename tIntegralImage2D<float, 3>::SecondOrderType tmp_so_elements;
    ...
    sumArea<typename tIntegralImage2D<float, 3>::ElementType>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFirstOrderSumSE, &integral_image_XYZ_, _1, _2, _3, _4), tmp_center);
    sumArea<typename tIntegralImage2D<float, 3>::SecondOrderType>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getSecondOrderSumSE, &integral_image_XYZ_, _1, _2, _3, _4), so_elements);
  ...
  else if (normal_estimation_method_ == AVERAGE_3D_GRADIENT)
  {
    ...
    sumArea<unsigned>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFiniteElementsCountSE, &integral_image_DX_, _1, _2, _3, _4), count_x);
    sumArea<unsigned>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFiniteElementsCountSE, &integral_image_DY_, _1, _2, _3, _4), count_y);
    ...
    sumArea<typename tIntegralImage2D<float, 3>::ElementType>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFirstOrderSumSE, &integral_image_DX_, _1, _2, _3, _4), gradient_x);
    sumArea<typename tIntegralImage2D<float, 3>::ElementType>(start_x, start_y, end_x, end_y, width, height, boost::bind(&tIntegralImage2D<float, 3>::getFirstOrderSumSE, &integral_image_DY_, _1, _2, _3, _4), gradient_y);
  ...
  else if (normal_estimation_method_ == AVERAGE_DEPTH_CHANGE)
  {
    ...
    sumArea<unsigned>(start_x_L, start_y_L, end_x_L, end_y_L, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFiniteElementsCountSE, &integral_image_depth_, _1, _2, _3, _4), count_L_z);
    sumArea<unsigned>(start_x_R, start_y_R, end_x_R, end_y_R, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFiniteElementsCountSE, &integral_image_depth_, _1, _2, _3, _4), count_R_z);
    sumArea<unsigned>(start_x_U, start_y_U, end_x_U, end_y_U, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFiniteElementsCountSE, &integral_image_depth_, _1, _2, _3, _4), count_U_z);
    sumArea<unsigned>(start_x_D, start_y_D, end_x_D, end_y_D, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFiniteElementsCountSE, &integral_image_depth_, _1, _2, _3, _4), count_D_z);
    ...
    sumArea<float>(start_x_L, start_y_L, end_x_L, end_y_L, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFirstOrderSumSE, &integral_image_depth_, _1, _2, _3, _4), mean_L_z);
    sumArea<float>(start_x_R, start_y_R, end_x_R, end_y_R, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFirstOrderSumSE, &integral_image_depth_, _1, _2, _3, _4), mean_R_z);
    sumArea<float>(start_x_U, start_y_U, end_x_U, end_y_U, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFirstOrderSumSE, &integral_image_depth_, _1, _2, _3, _4), mean_U_z);
    sumArea<float>(start_x_D, start_y_D, end_x_D, end_y_D, width, height, boost::bind(&tIntegralImage2D<float, 1>::getFirstOrderSumSE, &integral_image_depth_, _1, _2, _3, _4), mean_D_z);
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::computeFeature(PointCloudOut &output)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::computeFeatureFull(const float *distanceMap,
...
///////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointOutT> void
tIntegralImageNormalEstimation<PointInT, PointOutT>::computeFeaturePart(const float *distanceMap,
    const float &bad_point,
    PointCloudOut &output)
{
  if (border_policy_ == BORDER_POLICY_IGNORE)
...
tIntegralImageNormalEstimation<PointInT, PointOutT>::initCompute()
{
  ...
  return (tFeature<PointInT, PointOutT>::initCompute());
}
//----------------------------------------------------------------------
