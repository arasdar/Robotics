...
void tStereoProcessing::keyboardCallback(const pcl::visualization::KeyboardEvent& event, void*)
{
  if (event.keyUp())
  {
    ...
    case 'n':
      ...
      break;
    case 'p':
      display_plane_normals = !display_plane_normals;
      ...
      {
        removeSurfaceNormals(viewer_proc_trav_slopeAnalysis, prev_idx_normal);
        removeSurfaceNormals(viewer_proc_trav_slopeAnalysis_appear, prev_idx_appear);
      }
      break;
//    case 'a':
...
void tStereoProcessing::pointPickingcallback(const pcl::visualization::PointPickingEvent& event, void* args)
{
  ...
  /*Draw clicked points in red on viewer_5:*/
  ...
  /*Draw clicked points in red on viewer_6:*/
  data->viewerPtr_6->removePointCloud("clicked_points_6");
  data->viewerPtr_6->addPointCloud(data->clicked_points_3d, red, "clicked_points_6");
  data->viewerPtr_6->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 10, "clicked_points_6");
  ...
  data->viewerPtr_6->addText3D(ss.str(), current_point, textScale, r, g, b,  str);
