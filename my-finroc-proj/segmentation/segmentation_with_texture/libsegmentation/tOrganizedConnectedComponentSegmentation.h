...
//
//----------------------------------------------------------------------
/*!\file    projects/icarus/sensor_processing/libsegmentation/tOrganizedConnectedComponentSegmentation.h
 *
 * \author  Aras Dargazany
 *
 * \date    2014-04-29
 *
 * \brief   Contains tOrganizedConnectedComponentSegmentation
 *
 * \b tOrganizedConnectedComponentSegmentation
 *
 * This class OrganizedConnectedComponentSegmentation allows connected components to be found within organized point cloud data.
 *
 */
//----------------------------------------------------------------------
#ifndef __projects__stereo_traversability_experiments__daniel__segmentation_with_texture__libsegmentation__tOrganizedConnectedComponentSegmentation_h__
#define __projects__stereo_traversability_experiments__daniel__segmentation_with_texture__libsegmentation__tOrganizedConnectedComponentSegmentation_h__
...
//! SHORT_DESCRIPTION
/*!
 * This class OrganizedConnectedComponentSegmentation allows connected
...
class OrganizedConnectedComponentSegmentation : public pcl::PCLBase<PointT>
{
...
public:
  ...
  virtual ~OrganizedConnectedComponentSegmentation() {}  //You need this destructor if you allocated memory on the heap that must be free'd. Delete otherwise!
  ...
  void
  segment_texture(pcl::PointCloud<PointLT>& labels, std::vector<pcl::PointIndices>& label_indices) const;
...
#include "projects/stereo_traversability_experiments/daniel/segmentation_with_texture/libsegmentation/tOrganizedConnectedComponentSegmentation.hpp"
