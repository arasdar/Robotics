...
void tSSTA::processCloud_trav_stepAnalysis()
{
...
//                  cloud->points[segment_indices[i].indices[j]].r = 128;
//                  cloud->points[segment_indices[i].indices[j]].g = 128;
////                  cloud->points[segment_indices[i].indices[j]].g = 100;
              }
            }
            else
            {
