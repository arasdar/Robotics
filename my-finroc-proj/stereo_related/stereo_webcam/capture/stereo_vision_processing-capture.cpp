...
//    {
    ...
    Mat frame_l(l), frame_r(r);
    frame_l.copyTo(frame_1);
    frame_r.copyTo(frame_0);
  ...
  stereo_rectify_test(const Mat png_images_left_frame, const Mat png_images_right_frame)
  {
    ...
    png_images_left_frame.copyTo(img2);
    png_images_right_frame.copyTo(img1);
//    cvtColor(png_images_left_frame, img2, CV_BGR2GRAY);
//    cvtColor(png_images_right_frame, img1, CV_BGR2GRAY);
