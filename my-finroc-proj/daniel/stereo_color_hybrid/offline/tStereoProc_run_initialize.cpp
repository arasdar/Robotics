...
void tStereoProcessing::run_initialize()
{
  ...
  */
  ...
  cb_args.viewerPtr_6 = pcl::visualization::PCLVisualizer::Ptr(viewer_proc_segm_appear);
  ...
  viewer_proc_segm_appear ->removeAllPointClouds();
  ...
  for (int i = 0; i < 100; i++)
  {
    ...
    viewer_proc_segm_appear->removeText3D(text_id_str[i]);
