 ...
 */
//----------------------------------------------------------------------
#ifndef __projects__stereo_traversability_experiments__daniel__stereo_color_original__offline__tStereoProcessing_h__
#define __projects__stereo_traversability_experiments__daniel__stereo_color_original__offline__tStereoProcessing_h__
...
namespace daniel
{
namespace stereo_color_original
{
namespace offline
{
