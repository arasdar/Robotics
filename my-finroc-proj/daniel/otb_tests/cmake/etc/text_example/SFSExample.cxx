...
int main(int argc, char * argv[])
{
  ...
  if (argc != 9)
  {
      std::cerr << "Usage: " << argv[0] << " <inputImage> <outputImage> <outputImageRescaled>";
  ...
  std::string  outNameLength     = std::string(argv[2]) + "_lenght.tif";
  std::string  outNameWidth      = std::string(argv[2]) + "_width.tif";
  std::string  outNameWMean      = std::string(argv[2]) + "_wmean.tif";
  std::string  outNameRatio      = std::string(argv[2]) + "_ratio.tif";
  std::string  outNameSD         = std::string(argv[2]) + "_sd.tif";
  std::string  outNamePsi         = std::string(argv[2]) + "_psi.tif";
  std::string  lengthprettyfname     = std::string(argv[3]) + "_lenght.tif";
  std::string  widthprettyfname      = std::string(argv[3]) + "_width.tif";
  std::string  wmeanprettyfname      = std::string(argv[3]) + "_wmean.tif";
  std::string  ratioprettyfname      = std::string(argv[3]) + "_ratio.tif";
  std::string  sdprettyfname         = std::string(argv[3]) + "_sd.tif";
  std::string  psiprettyfname         = std::string(argv[3]) + "_psi.tif";
  PixelType    spectThresh         = atof(argv[4]);
  unsigned int spatialThresh    = atoi(argv[5]);
  unsigned int dirNb            = atoi(argv[6]);
  unsigned int maxConsideration = atoi(argv[7]);
