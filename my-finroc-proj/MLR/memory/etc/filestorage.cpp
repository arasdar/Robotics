...
int finroc::stereo_traversability_experiments::def::tMLR::filestorage(int ac, const char** av)
{
  ...
  string filename = av[1]; //parser.get<string>("@input");
  if (filename.empty() || ac < 2)
  {
    help(av);
    return 1;
  }
