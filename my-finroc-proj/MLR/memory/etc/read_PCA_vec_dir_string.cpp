...
void finroc::stereo_traversability_experiments::mlr::tMLR::read_PCA(std::vector<Mat>& pca_ /*not constant because it is an OUTPUT*/, const string& dir_path)
{
  ...
  const string dir_name = /*p.string()*/ dir_path + "/" + "learned_PCA"; // write the director at that  specific spot which the program is being executed
  ...
  //  pca_[0]=mean
  //  [1]=eigenvalues; VALUES
  //      [2]=eigenvectors; VECTORS
