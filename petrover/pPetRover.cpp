...
//
//----------------------------------------------------------------------
/*!\file    projects/petrover/pPetRover.cpp
 *
 * \author  Aras Dar
 *
 * \date    2018-05-04
 *
 * \brief Contains mPetRover
 *
 * \b pPetRover
 *
 * This is the petrover part/process for running petrover.
 *
 */
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//#include "projects/petrover/mPetRover.h"
...
// Const values
//----------------------------------------------------------------------
const std::string cPROGRAM_DESCRIPTION = "This program executes the PetRover module/group.";
...
//  new finroc::petrover::mPetRover(main_thread);
  new finroc::petrover::gPetRover(main_thread);
