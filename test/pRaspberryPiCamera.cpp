...
//
//----------------------------------------------------------------------
/*!\file    projects/test/pRaspberryPiCamera.cpp
 *
 * \author  Aras Dar
 *
 * \date    2018-04-09
 ...
 *
 * \b pRaspberryPiCamera
 *
 * This is the part for executing/running the Raspberry Pi camera.
 *
 */
//----------------------------------------------------------------------
...
//#include "projects/test/gRaspberryPiCamera.h"
...
// Const values
//----------------------------------------------------------------------
const std::string cPROGRAM_DESCRIPTION = "This program executes the RaspberryPiCamera module/group.";
...
void CreateMainGroup(const std::vector<std::string> &remaining_arguments)
{
  ...
  new finroc::test::mRaspberryPiCamera(main_thread);
//  new finroc::test::gRaspberryPiCamera(main_thread);
